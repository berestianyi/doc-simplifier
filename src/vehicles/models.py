...
class Vehicles(models.Model):
    ...
    vin_code = models.CharField(max_length=100, blank=True, default="")
    vehicle_type = models.CharField(choices=VehicleTypeEnum.choices, blank=True, default="")
    ...
    unladen_weight = models.CharField(max_length=100, blank=True, default="")
    laden_weight = models.CharField(max_length=100, blank=True, default="")
    engine_capacity = models.CharField(max_length=100, blank=True, default="")
    number_of_seats = models.CharField(max_length=100, blank=True, default="")
...
class VehicleLicences(models.Model):
    ...
    licence_number = models.CharField(max_length=50, default="", blank=True)
